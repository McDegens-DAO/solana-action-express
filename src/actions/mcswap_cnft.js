...
const standard = "CNFT";
// *********************************************************************************
mcswap_cnft.get('/'+name+'-config/*',async(req,res)=>{
    let error = false;
    let details = "";
    const obj = {}
    obj.type = "action";
...
mcswap_cnft.route('/'+name+'-complete').post(async function(req,res){
    const obj = {}
    const line = "\r\n";
    let details = "";
...
// *********************************************************************************
mcswap_cnft.get('/'+name+'-create',async(req,res)=>{
    const line = "\r\n";
...
mcswap_cnft.route('/'+name+'-create-complete').post(async function(req,res){
    const obj = {}
    const line = "\r\n";
    let details = "";
    let end_state = "Confirmed";
...
// *********************************************************************************
mcswap_cnft.route('/'+name+'-invalid').post(async function(req,res){
